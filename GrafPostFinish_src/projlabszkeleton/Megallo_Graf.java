		...
		this.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent me) {
				...
				if(me.getButton() == MouseEvent.BUTTON1){
					pressed = "leftMouseButton";
				}
				if(me.getButton() == MouseEvent.BUTTON3){
					pressed = "rightMouseButton";
				}
				mouseClicked_mine(pressed);
			}
		});
	}
	
	public void mouseClicked_mine(String pressed){
		if(pressed.equals("leftMouseButton")){
			s.increaseUtasokSzama();
		}
		else if(pressed.equals("rightMouseButton")){
			s.decreaseUtasokSzama();
		}
	}
