...
public class Palya {
	...
	/**
	 * Az első igazi (lehetetlen) pálya
	 */
	public void elsopalya(){
		...
		/*SpecialisHely[] spechelyek =new SpecialisHely[3];
		for(int i=0; i<3; i++){
			ss1[i]=new SpecialisHely("s");
		}*/
		Sin [] ss2 = new Sin [10];
		for(int i=0; i<2; i++){
			ss2[i]=new Sin("s");
		...
		add(new Elem[]{m1, m2, m3, m4, m5, k1, k2, k3, k4, k5, k6, k7, k8, k9, k10, k11, k12, k13, k14, k15, k16, k17});
		mozdonytar.ad(m1);
		mozdonytar.ad(m2);
		mozdonytar.ad(m3);
		mozdonytar.ad(m4);
		...
		try {
			...
			this.vonatlerakas(new Kocsi[]{m4, k10, k11, k12, k13, k14, k15}, new Sin[]{ss1[39], ss1[38], ss1[37], ss1[36], ss1[35], ss1[34], ss1[33], ss1[32]});
	 ...
	 * 
	 * @param tomb az összekapcsolandó elemek tömbje
	 */
	 ...
	 * 
	 * @param kocsik az lerakandó kocsik tömbje
	 * @param sinek a sinek ahova rakjuk a kocsikat
	 */
