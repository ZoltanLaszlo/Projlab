...
public class Valto extends Sin {
	 ...
	 * 3. hívásra a sin3 nevûbe rakja
	 * Minden további hívásra nem csinál semmit
	 * a valtó allasatól függõen elozo-bõl kovetkezo, vagy sin3 -ra léphet a mozdony
	 * sin3-ból és kovetkezo-ból pedig elozõ felé mehet a vonat
	 *
	 ...
	 * alapból az értéke false (vagyis elozo-bõl kovetkezõ fele megy)
	 * Minden váltás megcseréli az állást
	 * (ha true akkor elozo-bõl sin3 fele megy
	 *
	 */
	public void valts(){
		if(allas) {
