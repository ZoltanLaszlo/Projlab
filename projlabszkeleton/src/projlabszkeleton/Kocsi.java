...
public class Kocsi implements Elem{
	...
	/**
	minden kocsi ami nem mozdony igy lép tovább arr a mezőre amire az előtte álló kocsi küldi
	**/
	...
	/*a magallo hívja meg a kocsikon ha a szin megegyezik a kocsi ekkor ellenőrzi, 
		hogy az előtte lévő kocsi üres-e ha igen akkor nullára állítja az utasok számát*/
	public void leszallas(){
		System.out.println(">>k{Kocsi} calls"
				+ " Ures():boolean on "
				+ "elozo{Kocsi}");
		if(new Kocsi().ures()){
			System.out.println(">>k{Kocsi} calls"
					+ " setUtasokSzama(0):void on "
					+ "k{Kocsi}");
